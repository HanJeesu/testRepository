...
<%	
	...
	//로그인이 되어있다면 해당 유저 정보가 담긴 Member객체가 반환
...
<style>
    ...
    .menu a{
        ...
        font-size: 20px;
        font-weight: bold;
        display: block; /*block으로 지정 후 width/height 100%하면
                        해당 블럭에 꽉 차게 설정 가능*/
        width: 100%;
        height: 100%;
        line-height: 50px;
...
<body>
	...
	<script>
		...
		if(msg != "null"){
			alert(msg);
			//알람메세지 한 번 띄웠으면 지워주기 지우지 않으면 매번 menubar.jsp가 열릴 때마다 알림 뜸
...
<div class="login-area">
    ...
    <div id="user-info">
        ...
        <div align="center">
            ...
            <!-- <a href="<%=contextPath%>/update.me">정보변경</a> -->
        </div>
    </div>
    <%} %>
</div>
